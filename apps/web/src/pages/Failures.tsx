        ...
        <div className="flex gap-2">
          {data && data.pagination.total > 0 && (
            <button
              ...
              disabled={clearing}
              className="flex items-center gap-2 rounded-lg border border-neon-rose/50 bg-neon-rose/10 px-4 py-2.5 text-sm font-medium text-neon-rose transition-all active:bg-neon-rose/25 hover:bg-neon-rose/20 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {clearing ? (
                <>
          ...
          <Link
            to="/"
            className="flex items-center gap-2 rounded-lg border border-slate-700/50 bg-obsidian-800/40 px-4 py-2.5 text-sm font-medium text-slate-300 transition-all active:bg-obsidian-700/60 hover:bg-obsidian-700/50 hover:text-white"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
